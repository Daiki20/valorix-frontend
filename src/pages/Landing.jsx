        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "mainEntity": [
            ...
            },
            {
              ...
              "acceptedAnswer": { "@type": "Answer", "text": "Один AI-анализ матча стоит 46 монет. При регистрации вы получаете 15 монет бесплатно в подарок." }
            }
          ]
        })}</script>
      </Helmet>
          ...
          <div className="container" style={{ maxWidth: 760, margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {[
                ...
                { q: 'Сколько стоит один анализ?', a: 'Один анализ стоит 46 монет. Монеты можно пополнить в любое время через раздел "Пополнить".' },
