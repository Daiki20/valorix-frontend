          ...
          <div style={{
            ...
            <div style={{ flex: 1, minWidth: 260, position: 'relative' }}>
              <div style={{
                ...
                fontSize: 12, fontWeight: 700, color: A,
              ...
              <h3 style={{
                ...
                Есть аудитория?<br />
                <span style={{ color: A }}>Зарабатывай с нами</span>
              </h3>
              <p style={{
                fontFamily: 'Outfit, sans-serif',
                fontSize: 15, color: MUTED, lineHeight: 1.7, marginBottom: 24,
              }}>
              ...
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="white">
                  <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221l-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.447 1.394c-.16.16-.295.295-.605.295l.213-3.053 5.56-5.023c.242-.213-.054-.333-.373-.12L7.19 13.9l-2.96-.924c-.643-.204-.657-.643.136-.953l11.57-4.461c.537-.194 1.006.131.958.659z"/>
                </svg>
                Написать в Telegram
              </a>
            </div>
            ...
            <div style={{
              ...
              {[
                ...
                <div key={pct} style={{
                  ...
                  <span style={{
                    fontFamily: 'Space Grotesk, sans-serif',
                    fontSize: 26, fontWeight: 800, color, minWidth: 56,
                  }}>{pct}</span>
                  <span style={{
                    fontFamily: 'Outfit, sans-serif',
