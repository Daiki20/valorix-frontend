      ...
      <div className="card analysis-header" style={{ padding: '20px 24px' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, flex: 1, minWidth: 0 }}>
            <TeamCircle name={match.home} img={analysis.homeLogo || analysis.homeLogoTSDB || match.homeImg} size={44} />
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, flex: 1, minWidth: 0, justifyContent: 'flex-end' }}>
            ...
            <TeamCircle name={match.away} img={analysis.awayLogo || analysis.awayLogoTSDB || match.awayImg} size={44} />
          </div>
        </div>
      </div>
